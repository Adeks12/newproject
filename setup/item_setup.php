...
if(isset($_REQUEST['op']) && $_REQUEST['op'] == 'edit')
{
    ...
    if(empty($item_id)) {
        ...
        $itm_result = $dbobject->db_query($sql1, true); // <-- Corrected
    ...
    <form id="itemForm" onsubmit="return false" autocomplete="off">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control"
                value="<?php echo isset($item['item_code']) ? htmlspecialchars($item['item_code']) : 'Auto-generated'; ?>"
                readonly>
            ...
            <select name="category_id" class="form-control" required>
                ...
                if($categories) {
                    foreach($categories as $cat) {
                        $selected = ($item && isset($item['category_id']) && $item['category_id'] == $cat['item_cat_id']) ? "selected" : "";
                        echo "<option value='{$cat['item_cat_id']}' $selected>" . htmlspecialchars($cat['item_cat_name']) . "</option>";
                    }
                }
                ?>
            </select>
        ...
        <div class="form-group">
            ...
            <select name="item_condition" class="form-control" required>
                ...
                <option value="New"
                    <?php echo ($item && isset($item['item_condition']) && $item['item_condition']=='New')?'selected':''; ?>>
                    New</option>
                <option value="Good"
                    <?php echo ($item && isset($item['item_condition']) && $item['item_condition']=='Good')?'selected':''; ?>>
                    Good</option>
                <option value="Fair"
                    <?php echo ($item && isset($item['item_condition']) && $item['item_condition']=='Fair')?'selected':''; ?>>
                    Fair</option>
                <option value="Poor"
                    <?php echo ($item && isset($item['item_condition']) && $item['item_condition']=='Poor')?'selected':''; ?>>
                    Poor</option>
                <option value="Damaged"
                    <?php echo ($item && isset($item['item_condition']) && $item['item_condition']=='Damaged')?'selected':''; ?>>
                    Damaged</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="color" class="form-control"
                value="<?php echo isset($item['color']) ? htmlspecialchars($item['color']) : ''; ?>">
        </div>

        <div class="form-group">
            <label>Quantity <span class="asterik">*</span></label>
            <input type="number" name="quantity" class="form-control" required
                value="<?php echo isset($item['quantity']) ? htmlspecialchars($item['quantity']) : ''; ?>">
        </div>
        ...
        <div class="form-group">
            ...
            <select name="status" class="form-control" required>
                ...
                <option value="Available"
                    <?php echo ($item && isset($item['status']) && $item['status']=='Available')?'selected':''; ?>>
                    Available</option>
                <option value="Allocated"
                    <?php echo ($item && isset($item['status']) && $item['status']=='Allocated')?'selected':''; ?>>
                    Allocated</option>
                <option value="Reserved"
                    <?php echo ($item && isset($item['status']) && $item['status']=='Reserved')?'selected':''; ?>>
                    Reserved</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="date" name="purchase_date" class="form-control"
                value="<?php echo isset($item['purchase_date']) ? htmlspecialchars($item['purchase_date']) : ''; ?>">
        </div>

        <div class="form-group">
            <label>Warranty</label>
            <input type="text" name="warranty" class="form-control"
                value="<?php echo isset($item['warranty']) ? htmlspecialchars($item['warranty']) : ''; ?>">
        </div>

        <div class="form-group">
            <label>Location</label>
            <input type="text" name="location" class="form-control"
                value="<?php echo isset($item['location']) ? htmlspecialchars($item['location']) : ''; ?>">
        </div>

        <div class="form-group">
            <label>Created Date</label>
            <input type="text" class="form-control"
                value="<?php echo isset($item['created_at']) ? htmlspecialchars($item['created_at']) : date('Y-m-d H:i:s'); ?>"
                readonly>
        </div>
