...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 20, 2025 at 11:38 AM
...
(3, 'PRO-773289', 'PUB090', 'Publicity Department', '1', '4', 'Publicity', '2025-06-20 10:03:43', '2025-06-20 10:03:43', 'Jesuslovestestimony@gmail.com', 'Jesuslovestestimony@gmail.com'),
...
('PRO-773289', 'ITM927327', 1, 'new', 6, 'Green', 'allocated', 'Maintenance', '0', '4', '2025-06-19', 'Jesuslovestestimony@gmail.com', '2025-06-03 16:02:51', 'Jesuslovestestimony@gmail.com');
...
('019', 'Items Category', 'item.php', '#', ' ', '0', '2025-06-02 17:23:02', 0, 0, ''),
...
CREATE TABLE `staff` (
  ...
  `depmt_id` varchar(100) NOT NULL,
  `depmt_head` varchar(50) NOT NULL,
...
INSERT INTO `staff` (`merchant_id`, `staff_id`, `depmt_id`, `depmt_head`, `staff_code`, `staff_first_name`, `staff_middle_name`, `staff_last_name`, `staff_email`, `staff_phone_no`, `staff_description`, `staff_address`, `staff_status`, `created_at`, `created_officer`, `updated_at`, `updated_officer`) VALUES
('PRO-773289', 2, '3', '1', 'MIN761', 'Adekanmi', '', 'Victor', 'Jesuslovestestimony@', '09030642134', 'Web Developer', 'Rayfield Jos', '1', '2025-06-19 12:42:29', 'Jesuslovestestimony@gmail.com', '2025-06-19 12:42:29', 'Jesuslovestestimony@gmail.com'),
...
('PRO-773289', 4, '4', '1', 'MIN076', 'Stephen', '', 'James', 'James12@gmail.com', '0911209303', 'Web Developer', 'Pankshin Plateau State', '1', '2025-06-19 15:04:12', 'Jesuslovestestimony@gmail.com', '2025-06-19 15:04:12', 'Jesuslovestestimony@gmail.com');
...
--
ALTER TABLE `staff`
  MODIFY `staff_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
...
CREATE TABLE IF NOT EXISTS `items` (
  ...
  `merchant_id` VARCHAR(50) NOT NULL,
  `created_at` DATETIME NOT NULL,
  `created_officer` VARCHAR(100),
  `updated_at` DATETIME,
  `updated_officer` VARCHAR(100),
  PRIMARY KEY (`item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Table structure for table `item_allocation`
CREATE TABLE IF NOT EXISTS `item_allocation` (
  `allocation_id` INT(11) NOT NULL AUTO_INCREMENT,
  `item_id` INT(11) NOT NULL,
  `staff_id` INT(11) NOT NULL,
  `allocated_date` DATETIME NOT NULL,
