...
$merchant_id = $_SESSION['merchant_id'] ?? $merchant_id;
$active_dept_count = 0;
if ($merchant_id) {
                        ...
                        <div class="float-end">
                            ...
                            <div class="dropdown d-inline-block">
                                <button type="button" class="btn header-item waves-effect"
                                    ...
                                    <span
                                        class="d-none d-xl-inline-block ms-1"><?php echo htmlspecialchars($merchant_first_name); ?></span>
                                    <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                                </button>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <!-- item-->
                                    <a class="dropdown-item" href="#"
                                        onclick="getpage('profile.php','page'); return false;">
            ...
            <div class="vertical-menu">
                <div class="h-100">
                    <div class="user-wid text-center py-4">
                        ...
                        <div class="mt-3">
                            <a href="#"
                                class="text-body fw-medium font-size-16"><?php echo htmlspecialchars($merchant_first_name); ?></a>
                            <p class="text-muted mt-1 mb-0 font-size-13">
                                <?php echo htmlspecialchars($merchant_email); ?></p>
                        </div>
                    </div>
                    ...
                    <div id="sidebar-menu">
                        ...
                        $icon_map = [
                            ...
                            // Staff & Accounts
                            'staffs & account' => 'mdi-account-group-outline',
                            ...
                            //Store
                            'store' => 'mdi-store',
                            'manage store sections' => 'mdi-store',
                            'manage store' => 'mdi-store',
                        ...
                        ?>
                            ...
                            <li class="<?php echo $is_active; ?>">
                                <a href="javascript:getpage('<?php echo htmlspecialchars($menu_url); ?>','page')"
                                    class="waves-effect">
                                    <i class="mdi <?php echo htmlspecialchars($icon); ?>"></i>
                                    <span><?php echo ucfirst(htmlspecialchars($menu_name)); ?></span>
                                </a>
                            </li>
                            <?php else: ?>
                            <?php
                            ...
                            <li class="<?php echo $sub_active; ?>">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li class="<?php echo $is_sub_active; ?>">
                                        <a
                                            href="javascript:getpage('<?php echo htmlspecialchars($sub_url); ?>','page')">
                                            <i class="mdi <?php echo htmlspecialchars($sub_icon); ?>"></i>
                                            <?php echo ucfirst(htmlspecialchars($sub_menu_name)); ?>
                                        </a>
                                    </li>
                                    <?php endforeach; ?>
                                </ul>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-1">
                                                <div class="font-size-16 mt-2">Total Inventory</div>
                                            </div>
                                        </div>
                                        <h4 class="mt-4"><?php echo $total_new_inventory; ?></h4>
                                        <div class="row">
                                            <div class="col-7">
                                                <p class="mb-0"><span class="text-success me-2">
                                                        <?php echo $total_new_inventory > 0 ? '100%' : '0%'; ?>
                                                        <i class="mdi mdi-arrow-up"></i> </span></p>
                                            </div>
                                            <div class="col-5 align-self-center">
                                                <div class="progress progress-sm">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-1">
                                                <div class="font-size-16 mt-2">Quick Overview</div>
                                            </div>
                                        </div>
                                        <div class="mt-4">
                                            <div id="donut-chart" style="height: 120px;"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
